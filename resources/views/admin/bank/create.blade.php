...
@section('title', 'Tambah Bank - Admin Panel')

@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-[#183D57]">Tambah Bank</h1>
        <p class="text-gray-500">Menambahkan data bank baru</p>
    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Contoh: Bank Central Asia (BCA)</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kode" value="{{ old('kode') }}" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:border-[#8AD337] focus:ring-2 focus:ring-[#8AD337]/20">
                        <p class="text-xs text-gray-400 mt-1">Contoh: BCA, BNI, MANDIRI (akan otomatis uppercase)</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="atas_nama" value="{{ old('atas_nama') }}" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:border-[#8AD337] focus:ring-2 focus:ring-[#8AD337]/20">
                        <p class="text-xs text-gray-400 mt-1">Contoh: Yayasan Energi Bahagia</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex gap-3">
                            <div id="iconPreview"
                                ...
                                <i class="fas fa-university text-2xl text-[#8AD337]"></i>
                            </div>
                            <input type="text" name="icon" id="icon" value="{{ old('icon', 'fa-university') }}"
                        ...
                        <p class="text-xs text-gray-400 mt-1">Contoh: fa-university, fa-building, fa-credit-card</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex gap-3">
                            <div id="colorPreview" class="w-12 h-12 rounded-lg border"
                                style="background: {{ old('warna', '#183D57') }}"></div>
                            <input type="color" name="warna" id="warna" value="{{ old('warna', '#183D57') }}"
                                class="flex-1 px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:border-[#8AD337] focus:ring-2 focus:ring-[#8AD337]/20">
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6">
                    ...
                    <div id="livePreview" class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                        <div class="w-10 h-10 rounded-lg flex items-center justify-center"
                            style="background: {{ old('warna', '#183D57') }}20">
                            <i class="fas {{ old('icon', 'fa-university') }} text-xl"
                                style="color: {{ old('warna', '#183D57') }}"></i>
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800" id="previewNama">{{ old('nama_bank') ?: 'Nama Bank' }}
                            </p>
                            <p class="text-xs text-gray-500" id="previewRekening">
                                {{ old('nomor_rekening') ?: 'No. Rekening' }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            let nama = namaInput.value || 'Nama Bank';
            let rekening = rekeningInput.value || 'No. Rekening';
